...
@section('title', config('app.name', 'Laravel').' - Realizar Assinatura')
    ...
    <div>
        ...
        <form role="form" autocomplete="off" enctype="multipart/form-data" method="POST" action="scripts/employerAdd.php">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input style="text-transform: uppercase;" type="text" class="form-control" id="mac" name="mac">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn btn-success">
                                    <input type="radio" class="display-b" value="1" name="tipo_auth" id="hp">
                                    HotSpot
                                </label>

                                <label class="btn btn-success">
                                    <input type="radio" value="2" name="tipo_auth" id="ppp">
                                    PPPoE
                                </label>
                                <label class="btn btn-success">
                                    <input type="radio" class="display-b" value="3" name="tipo_auth" id="ipa">
                                    IP/ARP</label>
                                <label class="btn btn-success">
                                    <input type="radio" value="4" name="tipo_auth" id="dhcp">
                                    DHCP</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control complemento" id="complemento" name="complemento" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="cidade" id="cidade" class="form-control" required>
                            <input type="text" name="cidade2" id="cidade2" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control " disabled id="dia_vcto" name="dia_vcto" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control " disabled id="periodo" name="periodo">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" disabled id="vcto" name="vcto" placeholder="">
                            <input type="hidden" name="entrada2" id="entrada2">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="taxainstalacao" name="taxainstalacao" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="acrescimo" name="acrescimo" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3" aria-disabled="" id="isento_mensalidade">
                        ...
                        <div class="btn-group  btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-success">
                                <input type="radio" class="isento_mensalidade" name="isento_mensalidade" id="option_isento1" value="1" autocomplete="off"> Sim
                            </label>
                            <label class="btn btn-success active">
                                <input type="radio" class="isento_mensalidade" name="isento_mensalidade" id="option_isento2" value="2" autocomplete="off" checked> Não
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-success active">
                                <input type="radio" class="bloqueio_automatico" name="bloqueio_automatico" id="option1" value="1" autocomplete="off" checked> Sim
                            </label>
                            <label class="btn btn-success">
                                <input type="radio" class="bloqueio_automatico" name="bloqueio_automatico" id="option2" value="2" autocomplete="off"> Não
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-success active">
                                <input type="radio" class="permitir_alterar_senha" name="permitir_alterar_senha" id="option1" value="1" autocomplete="off" checked> Sim
                            </label>
                            <label class="btn btn-success">
                                <input type="radio" class="permitir_alterar_senha" name="permitir_alterar_senha" id="option2" value="2" autocomplete="off"> Não
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-success active">
                                <input type="radio" class="situacao_cliente" name="situacao_cliente" id="situacao1" value="1" autocomplete="off"> Ativo
                            </label>
                            <label class="btn btn-success">
                                <input type="radio" class="situacao_cliente" name="situacao_cliente" id="situacao2" value="2" autocomplete="off"> Bloqueado
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-footer">
                ...
                <button id="save" type="submit" class="btn btn-success" onclick="addAssinatura()">
                    <i class="fa fa-plus"></i> Realizar Assinatura</button>
            </div>
        </form>
